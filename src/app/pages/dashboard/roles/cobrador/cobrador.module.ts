...
@NgModule({
  declarations: [MisRutasCollectorComponent, InfoRutaCollectorComponent, RequestControlCollectorComponent, StatsCollectorComponent, CobradorComponent, ControlCobroCollectorComponent],
  imports: [
    DialogModule,
    CommonModule,
    BrowserModule,
